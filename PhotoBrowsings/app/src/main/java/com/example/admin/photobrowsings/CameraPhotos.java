...
public class CameraPhotos {
    ...
    public CameraPhotos(Context context) {
    ...
    public Intent takePhotoIntent() throws IOException {
        ...
        if(in.resolveActivity(this.context.getPackageManager()) != null) {
            ...
            if(photoFile != null) {
                in.putExtra("output", FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".provider", createImageFile()));
            }
        }
